                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="stat-card unread">
                            ...
                            <h3><?= number_format((int) ($stats['unread'] ?? 0)) ?></h3>
                        ...
                        <div class="card-modern card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="">
                                    ...
                                    <button type="submit" class="btn btn-primary-custom w-100" <?= !$notificationsAvailable ? 'disabled' : '' ?>>
                                    ...
                                    <?php foreach (array_slice($email_logs, 0, 10) as $log): ?>
                                        ...
                                        <div class="email-log-item">
                                            <div class="d-flex justify-content-between align-items-start">
                                                <div>
                                                    <strong><?= htmlspecialchars((string) ($log['subject'] ?? 'Notification email')) ?></strong><br>
                                                    <small>To: <?= htmlspecialchars((string) ($log['recipient_email'] ?? 'Unknown recipient')) ?></small>
                                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <form method="POST" action="" style="display: inline;">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-outline-secondary" <?= !$notificationsAvailable ? 'disabled' : '' ?>>
