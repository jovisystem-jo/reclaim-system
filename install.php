...
echo "3. Configure TWILIO_ACCOUNT_SID / TWILIO_AUTH_TOKEN and TWILIO_FROM_NUMBER for phone verification SMS\n";
echo "4. Configure IMAGGA_API_KEY / IMAGGA_API_SECRET if image tagging is needed\n";
echo "5. Access the website: " . $_SERVER['HTTP_HOST'] . "/reclaim-system/\n";
echo "\n";
